            ...
            <main className="lg:ml-[255px] min-h-screen">
                ...
                <div className="p-5 sm:p-8" style={{ paddingTop: '10px' }}>
                    ...
                    <div className="mt-8 bg-white rounded-2xl p-10 text-center shadow-[4px_4px_14px_rgba(0,0,0,0.04),-4px_-4px_14px_rgba(255,255,255,0.8)]">
                        ...
                        <h3 className="text-xl font-semibold mt-5">Store inventory API is not connected yet</h3>
                        <p className="text-sm text-[#8a8385] max-w-lg mx-auto mt-2 leading-6">The page and navigation are ready. Connect store-wise inventory endpoints when the backend inventory module is available.</p>
