...
const bannerSlides = [
  ...
  {
    image: "/images/hero-banner-3.jpeg",
  },
  {
...
const categories = [
  {
    name: "Flowers",
    image: "/images/flowers-category.png",
    bgColor: "bg-rose-50/80 group-hover:bg-rose-100/90",
    items: [
      "Roses",
      "Tulips",
      "Orchids",
  ...
  {
    name: "Cakes",
    image: "/images/cakes-category.png",
    bgColor: "bg-amber-50/80 group-hover:bg-amber-100/90",
    items: [
      "Chocolate Cakes",
      "Eggless Cakes",
      "Photo Cakes",
  ...
  {
    name: "Personalised",
    image: "/images/personalised-category.png",
    bgColor: "bg-purple-50/80 group-hover:bg-purple-100/90",
    items: [
      "Photo Frames",
      "Custom Mugs",
      "Engraved Gifts",
  ...
  {
    name: "Plants",
    image: "/images/plants-category.png",
    bgColor: "bg-emerald-50/80 group-hover:bg-emerald-100/90",
    items: [
      "Indoor Plants",
      "Succulents",
      "Bonsai",
  ...
  {
    name: "Combos",
    image: "/images/combos-category.png",
    bgColor: "bg-orange-50/80 group-hover:bg-orange-100/90",
    items: [
      "Flower & Cake",
      "Flower & Chocolate",
      "Hamper Boxes",
  ...
  {
    name: "LUXE",
    image: "/images/luxe-category.png",
    bgColor: "bg-yellow-50/80 group-hover:bg-yellow-100/90",
    items: [
      "Premium Roses",
      "Exotic Orchids",
      "Luxury Hampers",
  ...
  {
    name: "Gourmet",
    image: "/images/gourmet-category.png",
    bgColor: "bg-stone-100/80 group-hover:bg-stone-200/90",
    items: [
      "Chocolates",
      "Dry Fruits",
      "Cookies & Brownies",
...
export default function HomePage() {
  ...
  // Home page background sliding banner
  ...
  // Home page background sliding banner timing (Every 4 seconds)
  useEffect(() => {
  ...
  return (
    <main className="pb-16 md:pb-0">
      {/* Hero Banner (Mobile & Desktop - No Cropping) */}
      <section className="relative overflow-hidden pt-2 sm:pt-4 md:pt-6">
        <div className="max-w-[1500px] mx-auto px-3 sm:px-4">
          <div className="relative rounded-xl sm:rounded-2xl overflow-hidden aspect-[1600/533] shadow-sm sm:shadow-md md:shadow-xl bg-surface-container-low">
            ...
            <div className="absolute bottom-1.5 sm:bottom-3 md:bottom-4 left-1/2 -translate-x-1/2 flex gap-1.5 sm:gap-2.5 z-20">
              {bannerSlides.map((_, index) => (
                <button
                  key={index}
                  onClick={() => setCurrentSlide(index)}
                  aria-label={`Go to slide ${index + 1}`}
                  className={`h-1 sm:h-2 md:h-2.5 rounded-full transition-all duration-300 ${
                    index === currentSlide
                      ? "w-4 sm:w-6 md:w-8 bg-primary"
                      : "w-1 sm:w-2 md:w-2.5 bg-white/50 hover:bg-white/80"
                  }`}
                />
              ))}
            </div>
      ...
      {/* Category Bar */}
      <section className="py-4 sm:py-6 md:py-8 bg-[#faf7f5]/40 border-b border-outline-variant/40">
        <div className="max-w-container-max mx-auto px-3 sm:px-4">
          <div className="flex gap-4 sm:gap-6 md:gap-8 overflow-x-auto hide-scrollbar pb-2 md:justify-center items-center">
            {categories.map((cat) => (
              <Link
                key={cat.name}
                href={categoryRoutes[cat.name] || "#"}
              ...
              >
                ...
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-2xl sm:rounded-3xl p-1.5 sm:p-2 border border-outline-variant/60 ${cat.bgColor} shadow-sm group-hover:shadow-md group-hover:-translate-y-1.5 transition-all duration-300 flex items-center justify-center relative overflow-hidden`}
                >
                  <img
                    src={cat.image}
                    alt={cat.name}
                    loading="lazy"
                    className="w-full h-full object-cover rounded-xl sm:rounded-2xl transition-transform duration-300 group-hover:scale-110 drop-shadow-sm"
                  />
                </div>

                {/* Category Title */}
                <span className="text-xs sm:text-sm font-semibold text-on-surface group-hover:text-primary transition-colors tracking-tight text-center">
                  {cat.name}
                </span>
              </Link>
            ))}
