...
// API: GET /api/categories/thankyou/products — fetch Thank You products
const thankYouProducts = [
  {
    title: "Gratitude Rose Bouquet",
    description: "Soft pink roses, 15-piece bunch",
    price: "₹999",
    rating: "4.8 (960)",
    badge: "Top Rated",
    image:
  ...
  {
    title: "Thank You Chocolate Box",
    description: "Assorted Belgian chocolates, 24pc",
    price: "₹749",
    rating: "4.7 (610)",
    badge: "Same Day",
    image:
  ...
  {
    title: "Appreciation Hamper",
    description: "Flowers, cookies & thank you card",
    price: "₹1,349",
    rating: "4.9 (480)",
    badge: "Bestseller",
    image:
  ...
  {
    title: "Simple Gratitude Plant",
    description: "Money plant with thank you tag",
    price: "₹599",
    rating: "4.6 (390)",
    badge: null,
    image:
  ...
  {
    title: "Thank You Cake Slice Box",
    description: "6 assorted mini cake slices",
    price: "₹849",
    rating: "4.7 (320)",
    badge: null,
    image:
  ...
  {
    title: "Elegant Thanks Combo",
    description: "White lilies with scented candle",
    price: "₹1,199",
    rating: "4.8 (275)",
    badge: "New",
    image:
        ...
        <div className="w-full max-w-container-max mx-auto px-3 sm:px-4 md:px-6">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDeYtWlLaEkb52raoUB5UHe_ozMf1Fan6skG3SE6UH6xvVM5Oxd_4bxLrrqtEn20DeOywonQYJG7yF8OnKRIBMKkITGOIg8UIGr-TAZCDUDWYQN-klMHi-HYEZ-V0Jykn8d8T3YgM0IWXTwI4ABpdeBSRUoopPXZ_Pu9Bdte7Jbf7tb3vC2VUm_F1R7GPK0fVOX6cQhaAU_PcgkYHqqCNUiTjgWpb5xB2wkCOuC5Paf15WNHUwP2I_0OA')",
              }}
            />
            ...
            >
              <div className="w-full max-w-[92%] sm:max-w-lg">
                ...
                <p
                  ...
                  "
                >
                  Thoughtful flowers, sweets & hampers to say thanks in
                  style.
                </p>
        ...
        <div className="w-full max-w-container-max mx-auto px-3 sm:px-4 md:px-6">
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-5 md:mb-6">
            <p className="text-xs sm:text-sm text-on-surface-variant">
              {thankYouProducts.length} gifts found
            </p>
          </div>
