...
// API: GET /api/categories/getwell/products — fetch Get Well Soon products
const getWellProducts = [
  {
    title: "Cheerful Recovery Bouquet",
    description: "Bright gerberas & sunflowers, 20-piece",
    price: "₹1,099",
    rating: "4.8 (680)",
    badge: "Top Rated",
    image:
  ...
  {
    title: "Get Well Fruit Basket",
    description: "Fresh seasonal fruits, curated box",
    price: "₹899",
    rating: "4.7 (520)",
    badge: "Same Day",
    image:
  ...
  {
    title: "Speedy Recovery Hamper",
    description: "Flowers, fruits & get well card",
    price: "₹1,599",
    rating: "4.9 (390)",
    badge: "Bestseller",
    image:
  ...
  {
    title: "Healing Plant Gift",
    description: "Aloe vera plant with wellness note",
    price: "₹649",
    rating: "4.6 (310)",
    badge: null,
    image:
  ...
  {
    title: "Sunshine Get Well Bouquet",
    description: "Mixed yellow blooms, 18-piece",
    price: "₹949",
    rating: "4.7 (260)",
    badge: null,
    image:
  ...
  {
    title: "Comfort Care Combo",
    description: "Soup mix, flowers & warm blanket note",
    price: "₹1,349",
    rating: "4.8 (185)",
    badge: "New",
    image:
            ...
            >
              <div className="w-full max-w-[92%] sm:max-w-lg">
                ...
                <p
                  ...
                  "
                >
                  Flowers, fruits & thoughtful gifts to speed up their smile.
                </p>
        ...
        <div className="w-full max-w-container-max mx-auto px-3 sm:px-4 md:px-6">
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-5 md:mb-6">
            <p className="text-xs sm:text-sm text-on-surface-variant">
              {getWellProducts.length} gifts found
            </p>
          </div>
